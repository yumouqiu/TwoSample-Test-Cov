########################################################################################
##         Main part: used to calculate the power of the global MTT test               ##
##                                                                                    ##
#########################################################################################

n1s=c(80,100)        # sample size of the first population 
n2s=c(80,100)        # sample size of the second population 
ps=c(277,396)        # dimension of covariance matrix
 
r = 1          # signal strength
beta = 0.6     # sparsity level
